...
$upload_dir = '/anything.com/panel/upload/images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../upload/images/'; // relative path from filemanager folder to upload folder (with final /)
